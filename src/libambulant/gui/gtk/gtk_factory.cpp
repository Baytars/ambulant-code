...
ambulant_gtk_window::startScreenTransition()
{
	...
	if (m_fullscreen_count)
		logger::get_logger()->warn(gettext("%s:multiple Screen transitions in progress (m_fullscreen_count=%d)","ambulant_gtk_window::startScreenTransition()",m_fullscreen_count);
	m_fullscreen_count++;
